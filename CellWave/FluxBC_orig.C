...
int   FluxBC::getFluxBoundaryID() 
{ 
  return idFluxBoundary; 
};

void    FluxBC::setFluxCoefficient( double f ) 
{ 
  fluxCoefficient = f; 
};

double  FluxBC::getFluxCoefficient( ) 
{ 
  return fluxCoefficient; 
};

void     FluxBC::setDebug( int debug_ ) 
{ 
  debug= debug_; 
};
