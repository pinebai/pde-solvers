...
//void rhs(integertype N, realtype t, N_Vector y, N_Vector ydot,void *f_data);
//void (*CVodeRHSFunction) rhs;
...
main(int argc, char *argv[])
{
  ...
  cout << "callingCvode>> Enter the name of the (old) overlapping grid file:" << endl;
  cin >> nameOfOGFile;
