...
// 10x10      1 sec
// 100x100   42 sec  ( nonlin conv failures=1,  nni= 792   , nli=1911,  nsteps=695)
// 200x200  340 sec  ( nonlin conv failures=24, nni= 1341  , nli=4580,  nsteps=1140)
// 400x400
//
//
...
#define MX           400             /* MX = number of x mesh points */
#define MZ           400             /* MZ = number of z mesh points */
#define NSMX         800             /* NSMX = NUM_SPECIES*MX */
