...
int main(int argc, char **argv)
{
  ...
  try {
    ...
    DPrintf(BPRINT," --------------------------------------------------------------------- \n");
    DPrintf(BPRINT,"  .. ode2Buffer ..\n");
    DPrintf(BPRINT,"      simulating a well mixed LiRinzel rxn w/ 2 buffers\n");
    DPrintf(BPRINT," --------------------------------------------------------------------- \n");
    if(argc <= 1) {
      std::cerr <<"Usage: ode2Buffer <parameter file name>\n";
    ...
    chem.printParameters( CellWave:: DebugReaction );
    ...
    DPrintf(DebugSolver,
	      " t=%16.8f  c=%14.8f  h=%14.8f b1=%13.8f b2=%13.8f\n",tcomp,c,h,b1,b2);
	...
	fprintf(fOutput,
	 ...
	 tcomp,c,h,b1,b2, cFlux, hFlux, b1Flux, b2Flux );
      ...
      DPrintf(DebugSolver,
	      " t=%16.8f  %16.8f  %16.8f %16.8f %16.8f\n",tcomp,c,h,b1,b2);
      if(kstep== 0) {
